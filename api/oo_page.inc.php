...
class HTMLPage
{
    ...
    // Store the CSS Directory
    private $_dir_js = "";

    // Store the JavaScript Directory
    private $_dir_img = "";

    // Store the Images Directory
    private $_dir_fonts = "";

    // Store the Web Fonts Directory
    private $_dir_data = "";

    // Store the Data Directory
    private $_arr_js = [];

    // Store an Array of Scripts
    private $_arr_css = [];

    // Store an Array of CSS Files
    private $_arr_meta = [];

    // Store an Associative Array of Meta Files
    private $_head_title = "";
